...
<p className='text-shadow-2xs  text-lg leading-relaxed text-white mb-14'> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Optio dolorum, dicta nesciunt labore nihil ipsa.</p>
